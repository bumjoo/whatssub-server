...
const resolver: Resolvers = {
  ...
  User: {
    ...
    customServices: (_, args, { models }, info) => {
      return models.CustomService.findAll({
        where: {
          userId: _.id,
        },
      });
    },
    userProducts: (_, args, { models }, info) => {
      return models.UserProduct.findAll({
        where: {
          userId: _.id,
        },
      });
